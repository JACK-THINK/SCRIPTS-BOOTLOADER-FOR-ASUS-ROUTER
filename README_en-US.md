...
3. Login the router by `ssh` and run the line of code below to finish installation. If you want to install the system offline, please refer to the [How to use](./How_to_Use_en-US.md#Installation-Offline).
