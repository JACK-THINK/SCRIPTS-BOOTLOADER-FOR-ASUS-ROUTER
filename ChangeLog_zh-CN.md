...
1. 华硕路由器官方固件和梅林固件近期移除了对部分型号路由器的script_usbmount和script_usbumount的支持。为了适配此重大变更并确保对旧版固件的兼容性，本次更新同时支持前述引导方法和梅林固件特有的/jffs/scripts方法

   | 固件类型     | script_usbmount | /jffs/scripts | 本系统适配度                                                                 |
   | ------------ | --------------- | ------------- | ---------------------------------------------------------------------------- |
   | 新版官方固件 | *不支持*        | *不支持*      | 不适配。建议退回至202309之前的旧版固件或安装梅林固件                         |
   | 旧版官方固件 | **支持**        | *不支持*      | 完全适配                                                                     |
   | 新版梅林固件 | *不支持*        | **支持**      | 完全适配。必须启用`系统管理-系统设置-Enable JFFS custom scripts and configs` |
   | 旧版梅林固件 | **支持**        | **支持**      | 完全适配。两种引导可共存，无冲突                                             |
...
1. Entware_20221215发布，请参考使用手册升级系统
...
1. Entware_20220808发布，请参考使用手册升级系统
...
1. Entware_20211211发布，请参考使用手册升级系统
...
1. Entware_20210828发布，请参考使用手册升级系统
